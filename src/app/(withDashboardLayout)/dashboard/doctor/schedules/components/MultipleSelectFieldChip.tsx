...
export default function MultipleSelectFieldChip({ schedules, selectedScheduleIds, setSelectedScheduleIds }: any) {
    ...
    return (
        <div>
            <FormControl sx={{ width: "100%", minWidth: 250 }} size="small">
                <InputLabel id='demo-multiple-chip-label'>Schedule Slot</InputLabel>
                <Select
                    ...
                    input={<OutlinedInput id='select-multiple-chip' label='Schedule Slot' />}
